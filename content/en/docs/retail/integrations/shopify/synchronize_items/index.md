...
For the process to work, [data log subscribers]({{< ref "../autogenerated_setup/index.md" >}}) need to be registered. Data log subscribers create **Task List** entries which are processed by a [job queue entry]({{< ref "../autogenerated_setup/index.md" >}}).
...
- If the items in questions are [variants]({{< ref "../varieties/index.md" >}}), the following is sent:

   - Variant names and values
   - [SKU]({{< ref "../sku/index.md" >}})
...
- [Get orders from Shopify](({{< ref "../getting_orders/index.md" >}}).md)
