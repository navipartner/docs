...
2. Click **New** and populate the [<ins>available fields and options<ins>]({{< ref "../../explanation/voucher_types/index.md" >}}) in the **Retail Voucher Type Card**.
...
1. (Optional) If there's no partner code in the system, create one, and provide the **Code** and **Description**.
...
2. Set **Validate Voucher Module** to **DEFAULT**.
...
9. Provide the name of the managing company in **Service Company Name**.
