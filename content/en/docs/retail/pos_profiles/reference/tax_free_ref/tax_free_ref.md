...
| **Handler ID** | Specifies the tax-free solution that the POS unit should use. For example, use **GLOBALBLUE_I2** for the Global Blue tax-free solution when that integration is configured in your environment. |
