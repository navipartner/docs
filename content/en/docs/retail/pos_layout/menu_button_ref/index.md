---
title: "POS Menu Buttons Setup (reference guide)"
description: ""
lead: ""
...
Refer to the following table to see what each [POS menu button]({{< ref "../new_button/index.md" >}}) setting can be used for:
