...
1. Open the **POS Payment Bin** for the relevant POS unit and select **Insert Initial Float** in the ribbon.
...
1. Open **Report Selection - Retail** and configure the following settings:
...
If the button is marked in red, that means that the currency hasn't yet been counted. After the count is completed, there will be a green tick next to it.
...
Once the necessary configurations are complete, you can move on to [<ins>balancing the POS<ins>]({{< ref "../generate_eod/index.md" >}}) at the end of the work shift.
