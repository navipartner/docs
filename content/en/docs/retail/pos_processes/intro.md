...
- [<ins>Create a new POS unit (by using an existing one as reference)<ins>]({{< ref "how-to/create_pos_unit/index.md" >}})
- [<ins>Set up POS Payment Bins<ins>]({{< ref "how-to/payment_bins/index.md" >}})
...
- [<ins>Set up retail logo for printing<ins>]({{< ref "how-to/retail_logo/index.md" >}})
- [<ins>Set up sales price<ins>]({{< ref "how-to/sales_price_setup/index.md" >}})
...
- [<ins>Set up job queue to post POS entries<ins>]({{< ref "../posting_setup/how-to/job_queue/index.md" >}})
- [<ins>Manually post POS entries and check if they are posted<ins>]({{< ref "../posting_setup/how-to/manually_post_pos_entries/index.md" >}})
- [<ins>Set up digital receipts<ins>]({{< ref "how-to/digital_receipts/index.md" >}})
- [<ins>Transfer cash between POS units (BC procedure)<ins>]({{< ref "how-to/bin_transfer_action/index.md" >}})
- [<ins>Transfer cash with the POS Payment Bin Transfer Journal<ins>]({{< ref "how-to/transfer_cash_bc/index.md" >}})
- [<ins>Set up POS unit groups<ins>]({{< ref "how-to/pos_unit_groups/index.md" >}})
- [<ins>Set up sales price<ins>]({{< ref "how-to/sales_price_setup/index.md" >}})
- [<ins>Configure period registers<ins>]({{< ref "how-to/period_register/index.md" >}})
...
- [<ins>Start the day on POS<ins>]({{< ref "../pos_processes/how-to/start_pos/index.md" >}})
- [<ins>Conduct sales and returns on POS<ins>]({{< ref "../pos_processes/how-to/sales_cycle/index.md" >}})
...
- [<ins>POS actions<ins>]({{< ref "reference/pos_actions_ref/index.md" >}})
- [<ins>POS Counting screen<ins>]({{< ref "reference/counting_ref/index.md" >}})
- [<ins>NP Retail Job Queue Entries<ins>]({{< ref "../posting_setup/reference/job_queue_codeunits/index.md" >}})
- [<ins>Item add-ons<ins>]({{< ref "reference/item_addon_ref/index.md" >}})
- [<ins>Item categories<ins>]({{< ref "reference/item_categories/index.md" >}})
