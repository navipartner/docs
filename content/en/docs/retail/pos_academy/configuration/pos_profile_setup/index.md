...
- [<ins>**POS Inventory Profile**<ins>]({{< ref "../../../pos_profiles/how-to/inventory/index.md" >}}) - In the *Bring It to You Retail Store Ltd*, leave this field blank as the inventory profile isn't required.