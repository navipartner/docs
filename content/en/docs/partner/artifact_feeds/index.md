...
2. Once the account is ready, visit [<ins>Public Feeds project<ins>](https://navipartner.pkgs.visualstudio.com/PublicFeeds/_artifacts/feed/NaviPartner.NavApps).     

   The previous link is also accessible from [<ins>the main NaviPartner`s DevOps site<ins>](https://navipartner.visualstudio.com/).

3. From the **NaviPartner.NavApps** feed, choose the package you need and click it.     
