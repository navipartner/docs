...
3. Set the **Action Code** to **BG_SIS_FP_MGT**, and set the parameters for this action to **printDuplicate**.
...
2. Provide the name of the action, set the action type to **Action**, and enter the **BG_SIS_FP_MGT** action code.
...
2. Provide the name of the action in the **Caption**, set the action type to **Action**, and the action code to **BG_SIS_FP_MGT**.
