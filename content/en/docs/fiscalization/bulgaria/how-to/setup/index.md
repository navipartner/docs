...
3. Name the action (*Refresh Fiscal Printer Info*), set the action type to **Action**, and provide the **Action Code** - **BG_SIS_FP_MGT**.
   The changes are automatically saved.

  ![bg_fisc4](Images/bg_fisc4.PNG)

1. Open the POS.
2. Before logging in, click **System Setup**, and run the **Refresh Fiscal Printer Info** action.
...
1. Navigate to the **POS Menu** administrative section in Business Central.
2. Find **SYSTEM_MENU_LEFT** in the list, and click **Buttons** in the ribbon.
3. Name the action (*Set Cashier*), set the action type to **Action**, and provide the **Action Code** - **BG_SIS_FP_CASHIER**.
...
1. Navigate to the **POS Menu** administrative section in Business Central.
2. Find **SYSTEM_MENU_LEFT** in the list, and click **Buttons** in the ribbon.
3. Name the action (*Delete Cashier*), set the action type to **Action**, and provide the **Action Code** - **BG_SIS_FP_CASHIER**.
