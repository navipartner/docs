...
2. Locate the voucher type you previously created and open its **Retail Voucher Type Card**.
3. In the **Apply Payment** panel, change **Apply Payment Module** from **DEFAULT** to **Partial**.
   Configure this on the voucher type setup rather than on an individual voucher entry.
