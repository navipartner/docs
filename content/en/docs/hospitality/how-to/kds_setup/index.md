...
- Create a **POS Restaurant Profile**, and assign it to POS units.
...
6. Navigate to the **Rest. Item Routing Profiles** administrative section.
7. Create **Rest. Item Routing Profile** entries and use them to specify under which serving step the dishes are going to be served, and which print/production category they refer to.
...
9. Navigate to the item's **NPR Properties** panel, and assign the appropriate **Rest. Item Routing Profile**.
   In this way, you're notifying the system that the item needs to be sent to a specific kitchen station, and served to customers as part of a specific serving step.
