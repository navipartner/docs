...
- [<ins>Grouping<ins>]({{< ref "explanation/seating_grouping/index.md" >}})
- [<ins>Service flow (reference guide)<ins>]({{< ref "reference/service_flow/index.md" >}})
- [<ins>Restaurant card (reference guide)<ins>]({{< ref "reference/restaurant_card/index.md" >}})
- [<ins>Seating<ins>]({{< ref "explanation/seating_layout/index.md" >}})
- [<ins>Searing list (reference guide)<ins>]({{< ref "reference/seating_list/index.md" >}})
...
- [<ins>Admin Button (Restaurant Seating Plan View)<ins>]({{< ref "explanation/admin/index.md" >}})
